...
export class GuruService {
  ...
  async create(dto: CreateGuruDto) {
    ...
    const sudahGuru =
      await this.guruRepository.findOne({
        where: {
  ...
  async findAll(query: QueryGuruDto) {
    ...
    const qb =
      this.guruRepository.createQueryBuilder(
        'guru',
      );
  ...
  async remove(id: number) {
    ...
    await this.guruRepository.remove(
      guru,
    );
